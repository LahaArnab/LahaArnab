...
<strong>LLMs, Multimodal AI, Computer Vision, and Agentic AI</strong>.
</p>
...
- 📄 AI for Disaster Response & Medical Imaging
- ⚡ Scalable ML Pipelines using LangChain, FAISS & Pinecone
- 🌐 Full-Stack AI Applications using React, Node.js & Django
